...
import { setupEnvironment, setupLights, type BackLightEntry } from "./sceneLighting";
...
export class App {
  ...
  private backLights: BackLightEntry[] = [];
  ...
  async start(): Promise<void> {
    ...
    setupEnvironment(this.renderer, this.scene, this.settings.envIntensity);
    this.backLights = setupLights(this.scene);
